...
farm.events.create(
    ...
    botanic.events.create(
        ...
        location: "8500 West Deer Creek Canyon, Littleton, CO 80128",
        latitude: 39.549777,
        longitude: -105.147420,
